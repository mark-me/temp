...
class SourceConditionsTransform(BaseTransformer):
    ...
    def _handle_source_condition(
        ...
        parent_literal = self._get_parent_literal(condition)
        components = self._get_components(condition)
        source_condition_variable = self._handle_components(
    ...
    def _get_parent_literal(self, condition: dict) -> str:
    ...
    def _get_components(self, condition: dict) -> list[dict]:
    ...
    def _handle_source_condition_variable(
