DROP PROC [DA_MDDE].[sp_UpdateEntity_Execution]
GO
CREATE PROC [DA_MDDE].[sp_UpdateEntity_Execution] @par_runid [UNIQUEIDENTIFIER],@par_schema [NVARCHAR](500),@par_mapping [NVARCHAR](500) ,@par_outcome [NVARCHAR](500) AS
/***************************************************************************************************
