...
Met de tool kunnen gebruikers specifieke mappingstoringen simuleren en hun impact op het ETL-proces analyseren met behulp van verschillende propagatiestrategieën voor storingen. De resultaten worden gevisualiseerd en als afbeeldingen opgeslagen voor verdere analyse.
